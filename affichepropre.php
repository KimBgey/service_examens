...
<body>
	<?php 
	include 'menu.php';
$pdo = new PDO('mysql:host=localhost; dbname=service_examen;charset=utf8', 'root', '');
	 ?>
		...
		<thead>
			<tr class="success">
			<th  colspan="3" style="text-align: center;"> <?php echo $niv ?></th>
		</tr>
		<tr class="warning">
			<th colspan="3" style="text-align: center;">Etudiants</th>
		</tr> 
			<tr class="danger">
				<th rowspan="2" align="center"> Nom </th>
				<th  rowspan="2" align="center"> Prénoms </th>
</tr>
</thead>
<tbody>
	<?php  
...
<?php  } ?>
			...
			while ($donnees = $reponse->fetch()) {
			 ...
			 ?>
				<th colspan="12" style="text-align: center;"> <?php echo $donnees['libFiliere']; ?> </th>
			<?php } ?>
			</tr>
			<tr class="warning">
			...
			while ($donnees = $reponse->fetch()) {
			 ...
			 ?>
				<th colspan="4" style="text-align: center;"> <?php echo $donnees['libMatiere']; ?> </th>
				<?php } ?>
				
			</tr>
			<tr class="danger">
				<td align="center"> Controle Continu </td>
...
<p>
	<a href="affichenote.php"><h3>Retour sur la page de tri</h3> </a>
</p>
